/*
drop table if exists users, groups, students, assessments, assessments_lists, work_experiences, positions, chairs, educations, teachers, schedule;
*/
...
CREATE TABLE IF NOT EXISTS users ( --STORE USERS AT WEBSITE
    ...
    rights INTEGER NOT NULL, -- -1 FOR ADMIN, "0" FOR BLANK USER, "1" FOR STUDENT, "2" FOR TEACHER
...
CREATE TABLE IF NOT EXISTS teachers (
    ...
    education_id INTEGER REFERENCES educations(education_id) ON DELETE CASCADE ON UPDATE CASCADE,
    work_experience_id INTEGER REFERENCES work_experiences(work_experience_id) ON DELETE CASCADE ON UPDATE CASCADE,
    last_name VARCHAR(255) NOT NULL,
    name VARCHAR(255) NOT NULL,
    patronymic VARCHAR(255), --CAN BE NULL CAUSE THERE MIGHT BE NO PATRONYMIC OUTSIDE CIS
    phone_number INTEGER NOT NULL UNIQUE
